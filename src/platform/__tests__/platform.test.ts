...
import { createDensity, dp, sp, MDPI_DPI } from '@/platform/density'
import { detectSafeArea, ZERO_SAFE_AREA } from '@/platform/safe-area'
import { detectScreenInfo, createPlatformAdapter, inferOrientation } from '@/platform/screen-info'
import type { PlatformAdapter, ScreenInfo } from '@/platform/screen-info'
