...
import { createMockCtx, createMockCanvas } from '@/test-utils'
import type { Color, Point, DrawCommand, DrawScope, CanvasHost } from '@/renderer/types'
import { createFillRect, createFillCircle, createFillText, createSetAlpha } from '@/renderer/draw-command'
