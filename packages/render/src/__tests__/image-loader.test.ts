...
import { ImageCache, computeNinePatchRegions, computeNinePatchDestRegions, createImageLoader } from '../image-loader'
import { createDrawScope } from '../draw-scope'
import type { NinePatchConfig } from '../image-loader'
import { createMockCtx, createMockImageSource } from './mocks'
