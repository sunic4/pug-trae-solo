...
import type { DrawCommand, Color, FillRectCommand, FillCircleCommand, StrokeRectCommand, FillTextCommand, SaveCommand, SetAlphaCommand, RestoreCommand } from '../types'
