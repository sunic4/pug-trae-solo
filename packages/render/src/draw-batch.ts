import type { DrawContext, DrawCommand, Rect, Color, BatchFillCommand, BatchStrokeCommand, BatchTextCommand } from './types'
import { colorToString } from './types'
import { executePathCommands } from './draw-command'
import { mergeRects } from './dirty-region'
