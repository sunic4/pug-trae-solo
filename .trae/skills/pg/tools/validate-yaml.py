...
Usage examples:
  # Validate all .md files under pg/features
  python pg/tools/validate-yaml.py --dir pg/features

  # Validate a single file
  python pg/tools/validate-yaml.py --file pg/features/2026-04-11-auth/auth-design.md

  # Check that required fields exist in frontmatter
  python pg/tools/validate-yaml.py --dir pg/features --require doc_type --require status

  # JSON output for programmatic consumption
  python pg/tools/validate-yaml.py --dir docs/api --json

  # Validate the libdoc manifest
  python pg/tools/validate-yaml.py --file docs/api/manifest.yaml --yaml-only
"""
